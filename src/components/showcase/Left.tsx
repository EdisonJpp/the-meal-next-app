...
const Left = () => {
  return (
    <div className='py-2 flex-1 flex flex-col items-start justify-center gap-3'>
      ...
      <button className='bg-gradient-to-br from-orange-400 to-orange-500 w-full md:w-auto px-4 py-2 rounded-lg hover:shadow-lg transition-all ease-in-out duration-100  transform-gpu scale-100 hover:scale-[1.03] active:scale-[0.97]'>
        Order Now
      </button>
    </div>
  );
